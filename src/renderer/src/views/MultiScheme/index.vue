...
const fieldConfigs = computed(() => {
  ...
  const mPhysSimFields = [
    ...
    { key: 'innerBoundaryMirrorPosition', label: getFieldLabel('innerBoundaryMirrorPosition'), width: 140, unit: 'mm' },
    { key: 'gridGenerationMethod', label: getFieldLabel('gridGenerationMethod'), width: 120 },
    ...
    { key: 'bwgRadialProtrusionHeight', label: getFieldLabel('bwgRadialProtrusionHeight'), width: 140, unit: 'mm' },
    { key: 'bwgAxialHeight', label: getFieldLabel('bwgAxialHeight'), width: 120, unit: 'mm' },
    { key: 'bwgAxialPosition', label: getFieldLabel('bwgAxialPosition'), width: 140, unit: 'mm' },
    { key: 'radialGridRatio', label: getFieldLabel('radialGridRatio'), width: 120 },
    { key: 'feedingMethod', label: getFieldLabel('feedingMethod'), width: 120 },
    { key: 'compensationCoefficient', label: getFieldLabel('compensationCoefficient'), width: 120 },
    { key: 'streamlineData', label: getFieldLabel('streamlineData'), width: 120 },
  ]
